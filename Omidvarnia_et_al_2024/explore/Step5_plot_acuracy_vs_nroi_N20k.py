...
figures_folder = os.path.join(figures_folder, f'{model_type}_accuracy_vs_nroi_20k')
...
for target_no in range(N_targets):
    ...
    for n_feature in range(1, N_measures): # start from 1 to skip tSNR
        ...
        # -------------------------------------
        N_ROI_supraThresh_all = nroi_vec[::-1]
        im = ax.plot(
